  ...
  return (
    <div className="account-page">
      <article className="card account-hero">
        ...
        {(message || error) && (
          <p className={error ? 'alert' : 'gold'} style={{ margin: 0, maxWidth: 280, textAlign: 'right' }}>
            {error || message}
          </p>
        )}
      </article>
      ...
      <div className="account-pair">
        <article className="card account-panel">
              ...
              {!editing ? (
                ...
                >
                  <svg viewBox="0 0 16 16" aria-hidden="true">
                    <path d="M2 11.5V14h2.5L12.2 6.3 9.7 3.8 2 11.5zm11.1-6.1 1.5-1.5c.4-.4.4-1.1 0-1.5L13.6 1.4c-.4-.4-1.1-.4-1.5 0L10.6 2.9l2.5 2.5z" />
                  </svg>
                </button>
              ) : (
                <div className="toolbar">
                  ...
                  >
                    <svg viewBox="0 0 16 16" aria-hidden="true">
                      <path d="M1 8.2 5.6 13 15 2.4 13.5 1 5.6 10 2.4 6.7z" />
                    </svg>
                  </button>
                  <button
                    type="button"
                  ...
                  >
                    <svg viewBox="0 0 12 12" aria-hidden="true">
                      <path d="M1.2.4 6 5.2 10.8.4 12 1.6 7.2 6.4 12 11.2 10.8 12.4 6 7.6 1.2 12.4 0 11.2 4.8 6.4 0 1.6z" />
                    </svg>
                  </button>
                </div>
              )}
          ...
          <fieldset disabled={!editing} style={{ border: 0, padding: 0, margin: 0 }}>
            <div className="field">
